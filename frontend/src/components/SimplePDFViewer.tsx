...
/**
 * Förenklad PDF-visare utan ikoner för att undvika timeouts
 */
        ...
        >
          ...
          >
            ...
            <Box sx={{ display: 'flex', gap: 1 }}>
              ...
              <Button size="sm" variant="plain" color="neutral" onClick={zoomOut}>
                -
              </Button>
              <Typography level="body-sm" sx={{ display: 'flex', alignItems: 'center', minWidth: '50px', justifyContent: 'center' }}>
                {zoomLevel}%
              </Typography>
              <Button size="sm" variant="plain" color="neutral" onClick={zoomIn}>
                +
              </Button>
