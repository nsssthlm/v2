...
const mainMenuItems = [
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        <path d="M8 13v-1h4v1H8zm0 3v-1h8v1H8zm-2.55-7h13.1c.3 0 .55.25.55.55 0 .24-.16.45-.4.53l-6.6 1.97c-.11.03-.22.03-.33 0l-6.6-1.97a.546.546 0 01-.17-1.03c.07-.03.14-.05.22-.05z" />
        <path d="M18.24 5H5.76C4.79 5 4 5.79 4 6.76v10.48c0 .97.79 1.76 1.76 1.76h12.48c.97 0 1.76-.79 1.76-1.76V6.76c0-.97-.79-1.76-1.76-1.76zm.26 12H5.5a.5.5 0 01-.5-.5v-11a.5.5 0 01.5-.5h13a.5.5 0 01.5.5v11a.5.5 0 01-.5.5z" />
      </svg>
    ),
    submenu: [],
    badge: "New",
  ...
  },
  {
    ...
    submenu: [{ name: "Meddelanden", path: "/communication/messages" }],
    collapsible: true,
  },
  {
    name: "3D Viewer",
                ...
                >
                  ...
                  {item.submenu.length > 0 && (
                    <svg
                      ...
                      fill="currentColor"
                      style={{
                        transform: openSubmenus[item.path]
                          ? "rotate(0deg)"
                          : "rotate(-90deg)",
                      ...
                      >
                        ...
                        >
                          <svg
                            ...
                            opacity={0.5}
                          >
                            {subitem.name.includes("Kanban") && (
                              <path d="M4 11h6v8H4zm8-8h6v16h-6z" />
                            )}
                            {subitem.name.includes("Gantt") && (
                              <path d="M4 11h6v2H4zm0 4h6v2H4zm0-8h6v2H4zm8 0h8v2h-8zm0 4h8v2h-8zm0 4h8v2h-8z" />
                            )}
                            {subitem.name.includes("Ekonomi") && (
                              <path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z" />
                            )}
                            {subitem.name.includes("Meddelanden") && (
                              <path d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z" />
                            )}
                            {subitem.name.includes("Översikt") && (
                              <path d="M16 15h-2V5h2v10zm-8 0H6V5h2v10zm12-7h-2v4h2V8zM8 8H6v4h2V8z" />
                            )}
                            {subitem.name.includes("Design") && (
                              <path d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7z" />
                            )}
                            {subitem.name.includes("Byggarbetsplats") && (
                              <path d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z" />
                            )}
                            {subitem.name.includes("Home") && (
                              <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" />
                            )}
                            {subitem.name.includes("Comments") && (
                              <path d="M21.99 4c0-1.1-.89-2-1.99-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14l4 4-.01-18zM18 14H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z" />
                            )}
                            {subitem.name.includes("Review Package") && (
                              <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-5 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z" />
                            )}
                            {subitem.name.includes("Files") && (
                              <path d="M6 2c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6H6zm7 7V3.5L18.5 9H13z" />
                            )}
                            {subitem.name.includes("Versionsset") && (
                              <path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z" />
                            )}
                            {subitem.name.includes("Meetings") && (
                              <path d="M12 4c4.41 0 8 3.59 8 8s-3.59 8-8 8-8-3.59-8-8 3.59-8 8-8m0-2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 9h4V9h-4V6h-2v3H7v2h4v3h-4v2h4v3h2v-3h4v-2h-4v-3z" />
                            )}
                          </svg>
                        </Box>
                        <ListItemContent>
                        ...
                        {"hasAddButton" in subitem &&
                          Boolean(subitem.hasAddButton) && (
                            <IconButton
                              size="sm"
                              variant="plain"
                              color="neutral"
              ...
              {openFolders["files_root"] && (
                ...
                >
                  ...
                  >
                    ...
                    {filesystemNodes.filter((node) => node.parent_id === null)
                      .length === 0 && (
                      <Typography
                        level="body-xs"
                        sx={{
