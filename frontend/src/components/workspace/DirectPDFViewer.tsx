...
export default function DirectPDFViewer({ pdfUrl, title }: DirectPDFViewerProps) {
    ...
    <Box sx={{ 
      ...
      {loading ? (
        ...
        <Box sx={{ 
          ...
          {/* 
            Try <object> tag instead of iframe, which is generally better supported 
            for PDF embedding and has fewer security restrictions
          */}
          <object
            data={fullUrl}
            ...
            style={{ border: 'none' }}
          >
            <Typography level="body-lg" sx={{ p: 2 }}>
              Din webbläsare kan inte visa den inbäddade PDF:en.
              <br />
              <Button 
